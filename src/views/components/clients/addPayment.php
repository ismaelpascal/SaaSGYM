<div id="addPaymentModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center">
    ...
    <div class="bg-white p-8 rounded-lg shadow-xl w-full max-w-lg">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <button id="closePaymentModalBtn" class="text-gray-400 hover:text-gray-600 text-3xl">&times;</button>
        </div>

        <form id="addPaymentForm" method="POST" class="space-y-4">
            <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" id="paymentAmount" name="monto" required class="w-full px-4 py-2 border border-gray-300 rounded-lg" placeholder="$7,500">
                </div>
                <div>
                    <label for="paymentMethod" class="block text-sm font-medium text-gray-700 mb-1">Método de Pago</label>
                    <select id="paymentMethod" name="metodoPago" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-white">
            ...
            <div class="pt-4 flex justify-end space-x-2">
                 ...
                 <button type="submit" id="confirmPaymentBtn" class="bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700">Confirmar Pago</button>
            </div>
        </form>
